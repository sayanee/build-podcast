...
2. Install Apache Server
    ...
    ```
3. Ensure that the default folder exisrs

    ```
    cd ../../var/www/html/
    ```
4. Start the Apache server and check its status

    ```
    sudo service httpd start
    sudo service httpd status
    ```
5. visit the *ec2 public dns* with the address[http://ec2-xx-xxx-xx-xxx.compute-1.amazonaws.com](#) and it should show a default Amazon Linux AMI Test Page
...
4. [Capistrano Tasks](https://github.com/capistrano/capistrano/wiki/Capistrano-Tasks)

#Related Build Podcast episodes

1. [bash](http://build-podcast.com/bash/), [ssh](http://build-podcast.com/ssh/), [aws](http://build-podcast.com/aws/)
2. [git](http://build-podcast.com/git/) and [github](http://build-podcast.com/github/)
